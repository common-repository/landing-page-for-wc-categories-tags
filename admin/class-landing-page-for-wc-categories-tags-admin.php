...
class WC_Landing_Page_For_Category_Tag_Admin {
	...
	public function wc_lp_categories_tags_admin_menu_page() {
		add_menu_page( 
			__( 'Landing Page for WooCommerce Archive Pages Settings', 'landing-page-for-wc-categories-tags' ),
			__( 'Landing Page for WC Archive Pages', 'landing-page-for-wc-categories-tags' ),
			'manage_options',
	...
	public function wc_lp_categories_tags_callback() { ?>
		<div class="wrap wc-lp-wrapper">
			<h1><?php _e( 'Landing Page for WooCommerce Archive Pages Settings', 'landing-page-for-wc-categories-tags' ); ?></h1>
