 ...
 class WC_Landing_Page_For_Tag_Description {
	...
	public function wc_lp_categories_tags_add_tag_page() {
		...
		<div class="form-field">
			<label for="wc_lp_top_tags"><?php echo __( 'Top Description', 'landing-page-for-wc-categories-tags' ); ?></label>       
		...
		?>
			<div class="form-field">
				<label for="wc_lp_bottom_tags"><?php echo __( 'Bottom Description', 'landing-page-for-wc-categories-tags' ); ?></label>
	...
	public function wc_lp_categories_tags_edit_tag_page( $term ) {
		...
		<tr class="form-field">
			<th scope="row" valign="top">
				<label for="wc_lp_tags_top_description"><?php echo __( 'Top Description', 'landing-page-for-wc-categories-tags' ); ?></label>
			</th>
			<td>
		...
		<tr class="form-field">
			<th scope="row" valign="top">
				<label for="wc_lp_tags_bottom_description"><?php echo __( 'bottom Description', 'landing-page-for-wc-categories-tags' ); ?></label>
			</th>
			<td>
