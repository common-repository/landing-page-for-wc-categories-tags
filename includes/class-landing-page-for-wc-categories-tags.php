...
class WC_Landing_Page_For_Category_Tag {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Landing_Page_For_Category_Tag_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Landing_Page_For_Category_Tag_Loader. Orchestrates the hooks of the plugin.
	 * - Landing_Page_For_Category_Tag_i18n. Defines internationalization functionality.
	 * - Landing_Page_For_Category_Tag_Admin. Defines all hooks for the admin area.
	 * - Landing_Page_For_Category_Tag_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Landing_Page_For_Category_Tag_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Landing_Page_For_Category_Tag_Loader    Orchestrates the hooks of the plugin.
	 */
